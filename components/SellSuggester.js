...
function SellSuggester({name, symbol, image, priceA, priceB,}) {
    if(priceA<priceB){
        ...
        {/* Right */}
        <div>
            <h2 className = "text-white" >{name}({symbol}){priceB}</h2>
            < h3 className = "text-white" >Sell From CoinGecko</h3>
        </div>
        </div>
